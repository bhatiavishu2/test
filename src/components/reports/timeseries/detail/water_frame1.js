...
class WaterFrame1 extends Component{
  ...
  return(
    <div className="modal-body">
      ...
      <div className="form-group">
        <label className="col-sm-4 control-label">Consumption</label>
        <div className="col-sm-8">
          <input type="text" className="form-control" id="in3" value={this.props.data["m2m:sgn"]["nev"]["rep"]["m2m:cin"]["con"]["payloads_ul"]["dataFrame"]["consumption"]} readOnly="readonly"/>
        </div>
      </div>
      <div className="form-group">
