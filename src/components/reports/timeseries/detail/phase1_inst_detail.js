...
class Phase1Instantanious extends Component{
  ...
  return(
    <div className="modal-body">
      ...
      <div className="form-group">
        <label className="col-sm-4 control-label">Inst. Voltage (V)</label>
        <div className="col-sm-8">
          <input type="text" className="form-control" id="in2" value={this.props.data["m2m:sgn"]["nev"]["rep"]["m2m:cin"]["con"]["payloads_ul"]["dataFrame"]["inst_voltage"]} readOnly="readonly"/>
        </div>
      </div>
      <div className="form-group">
        <label className="col-sm-4 control-label">Inst. Current (A)</label>
        <div className="col-sm-8">
          <input type="text" className="form-control" id="in3" value={this.props.data["m2m:sgn"]["nev"]["rep"]["m2m:cin"]["con"]["payloads_ul"]["dataFrame"]["inst_current_in_a"]} readOnly="readonly"/>
        </div>
      </div>
...
export default Phase1Instantanious;
