...
class Phase3LoadProfile extends Component{
  ...
  return(
    <div className="modal-body">
      ...
      <div className="form-group">
        <label className="col-sm-4 control-label">Data Record(1) (KW) MD</label>
        <div className="col-sm-8">
          <input type="text" className="form-control" id="in3" value={this.props.data["m2m:sgn"]["nev"]["rep"]["m2m:cin"]["con"]["payloads_ul"]["dataFrame"]["load_profile_data_record_1"]["load_profile_data_record_in_kw_md"]} readOnly="readonly"/>
        </div>
      </div>
      <div className="form-group">
        <label className="col-sm-4 control-label">Data Record(1) Voltage</label>
        <div className="col-sm-8">
          <input type="text" className="form-control" id="in2" value={this.props.data["m2m:sgn"]["nev"]["rep"]["m2m:cin"]["con"]["payloads_ul"]["dataFrame"]["load_profile_data_record_1"]["load_profile_data_record_voltage"]} readOnly="readonly"/>
        </div>
      </div>
      <div className="form-group">
        <label className="col-sm-4 control-label">Data Record(1) Current</label>
        <div className="col-sm-8">
          <input type="text" className="form-control" id="in3" value={this.props.data["m2m:sgn"]["nev"]["rep"]["m2m:cin"]["con"]["payloads_ul"]["dataFrame"]["load_profile_data_record_1"]["load_profile_data_record_current"]} readOnly="readonly"/>
        </div>
      </div>
      ...
      <div className="form-group">
        <label className="col-sm-4 control-label">Data Record(2) (KW) MD</label>
        <div className="col-sm-8">
          <input type="text" className="form-control" id="in3" value={this.props.data["m2m:sgn"]["nev"]["rep"]["m2m:cin"]["con"]["payloads_ul"]["dataFrame"]["load_profile_data_record_2"]["load_profile_data_record_in_kw_md"]} readOnly="readonly"/>
        </div>
      </div>
      <div className="form-group">
        <label className="col-sm-4 control-label">Data Record(2) Voltage</label>
        <div className="col-sm-8">
          <input type="text" className="form-control" id="in2" value={this.props.data["m2m:sgn"]["nev"]["rep"]["m2m:cin"]["con"]["payloads_ul"]["dataFrame"]["load_profile_data_record_2"]["load_profile_data_record_voltage"]} readOnly="readonly"/>
        </div>
      </div>
      <div className="form-group">
        <label className="col-sm-4 control-label">Data Record(2) Current</label>
        <div className="col-sm-8">
          <input type="text" className="form-control" id="in3" value={this.props.data["m2m:sgn"]["nev"]["rep"]["m2m:cin"]["con"]["payloads_ul"]["dataFrame"]["load_profile_data_record_2"]["load_profile_data_record_current"]} readOnly="readonly"/>
        </div>
      </div>
    </div>
  );
...
export default Phase3LoadProfile;
