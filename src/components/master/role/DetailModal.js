...
import {doCloseDetailsModal} from '../../../actions/master/role';
...
class DetailModal extends Component {
  ...
  renderDetail() {
        return (<RoleTabPaneAdd initialValues={this.props.selectedData} action="edit" initializer={() => this.props.initializer()}/>);
  }
  render() {
...
function mapStateToProps(state) {
  //console.log(state);
  return {
      showDetailsModal: state.role.showDetailsModal,
      selectedData: state.role.selectedData,
      popover: 'popover',
      tooltip: 'tooltip'
