...
import { search } from '../../../actions/master/device_profile';
						...
						<div className="col-xs-12">
							<div className="OuterTables">
								<div className="table-responsive">
									<table className="table table-striped table-bordered text-center" id="device_profileList">
										<thead>
											<tr>
                        <th>Device Type</th>
                        <th>Device Profile Id</th>
                        <th>Device Profile Name</th>
                        <th>MAX Consumption Threshold</th>
                        <th>Reporting Frequency in Minutes</th>
                        <th>Battery Threshold</th>
                        <th>Action</th>
                      </tr>
										</thead>
										<tbody>
...
function mapStateToProps(state) {
  ...
  return {
      ...
      searchData: state.device_profile.searchData,
      showDownloadSuccessCommand:state.device_profile.showDownloadSuccessCommand
  };
}
