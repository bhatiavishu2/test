...
import {doCloseDetailsModal} from '../../../actions/master/property';
...
class DetailModal extends Component {
  ...
  renderDetail() {
        return (<PropertyTabPaneAdd initialValues={this.props.selectedData} action="edit"  initializer={() => this.props.initializer()}/>);
  }
  render() {
...
function mapStateToProps(state) {
  //console.log(state);
  return {
      showDetailsModal: state.property.showDetailsModal,
      selectedData: state.property.selectedData,
      popover: 'popover',
      tooltip: 'tooltip'
