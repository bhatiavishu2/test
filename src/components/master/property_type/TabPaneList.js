						...
						<div className="col-xs-12">
							<div className="OuterTables">
								<div className="table-responsive">
									<table className="table table-striped table-bordered text-center" id="property_typeList">
										<thead>
											<tr>
                        <th>NAME</th>
                        <th>SITE</th>
...
function mapStateToProps(state) {
  ...
  return {
      ...
      searchData: state.property_type.searchData,
      showDownloadSuccessCommand:state.property_type.showDownloadSuccessCommand
  };
}
