...
import { search } from '../../../actions/master/site';
						...
						<div className="col-xs-12">
							<div className="OuterTables">
								<div className="table-responsive">
									<table className="table table-striped table-bordered text-center" id="siteList">
										<thead>
											<tr>
                        <th>Site Id</th>
...
function mapStateToProps(state) {
  ...
  return {
      ...
      searchData: state.site.searchData,
      showDownloadSuccessCommand:state.site.showDownloadSuccessCommand
  };
}
