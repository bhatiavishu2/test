...
import { search } from '../../../actions/master/user';
						...
						<div className="col-xs-12">
							<div className="OuterTables">
								<div className="table-responsive">
									<table className="table table-striped table-bordered text-center" id="userList">
										<thead>
											<tr>
                        <th>User Type</th>
                        <th>Name</th>
...
function mapStateToProps(state) {
  ...
  return {
      ...
      showDownloadSuccessCommand:state.user.showDownloadSuccessCommand
  };
}
